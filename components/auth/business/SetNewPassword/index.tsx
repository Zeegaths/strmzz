...
/**
 * Renders a form for setting a new business account password.
 */
const BusinessSetNewPasswordForm = () => {
  ...
  const onSubmit = async (data: SetNewPasswordInput) => {
    try {
      console.log('Business new password created', data);

      // TODO: Replace with actual API call
      // await setBusinessNewPassword(data.password);
    ...
    <div className="shadow-authCardShadow md:w-[380px] w-full rounded-[16px] bg-white border border-[#E5E7EB] flex flex-col gap-4 items-center py-8 px-6 relative">
      ...
      <div className="w-full flex flex-col gap-3">
        ...
        <p className="font-poppins font-[400] text-[14px] leading-[24px] text-[#58556A] text-center px-3">
          Set a strong password to secure your business account.
        </p>
      </div>
...
export default BusinessSetNewPasswordForm;
