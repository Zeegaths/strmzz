        ...
        () => [
            {
                ...
                cell: ({ getValue }) => (
                    <span className="text-[#050020] font-poppins font-[400] text-sm">
                        {getValue() as string}
                    </span>
                ),
            },
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <span className="text-[#050020] font-poppins font-[500] text-sm">
                        {formatCurrency(row.original.totalSpent)} <span className='text-[#58556A] font-[400]'>{row.original.token}</span>
                    </span>
                ),
            },
            {
                ...
                <table className="w-full min-w-[800px]">
                    ...
                    <tbody>
                        {table.getRowModel().rows.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan={6} className="px-4 py-8 text-center text-[#6B7280] font-poppins text-sm">
                                    No customers found
                                </td>
                            </tr>
                        )}
